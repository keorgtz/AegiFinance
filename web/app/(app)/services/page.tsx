      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-card bg-[#F5F0FF] text-[#6B46C1]">
              <Package className="h-4 w-4" />
            </div>
            <div className="min-w-0">
              <p className="truncate font-600 text-[#16181D]">{s.name}</p>
              {s.categoryName && (
                <p className="truncate text-[11px] text-[#5B6472]">{s.categoryName}</p>
              )}
            </div>
          </div>
        );
  ...
  return (
    <div>
      ...
      <div className="mb-5 flex items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-[22px] font-700 text-[#16181D]">
