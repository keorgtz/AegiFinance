    ...
    public partial class AddClientManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientClientTag", x => new { x.ClientId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ClientClientTag_ClientTags_TagId",
                        column: x => x.TagId,
                        principalTable: "ClientTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientClientTag_Clients_ClientId",
                        column: x => x.ClientId,
