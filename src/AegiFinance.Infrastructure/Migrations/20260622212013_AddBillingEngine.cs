...
{
    /// <inheritdoc />
    public partial class AddBillingEngine : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemsGenerated = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillingGenerationLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillingGenerationLogs_BillingCycles_BillingCycleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillingItems_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillingItems_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingCycles_Year_Month",
                table: "BillingCycles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingGenerationLogs_BillingCycleId",
                table: "BillingGenerationLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingItems_ClientId_Status",
                table: "BillingItems",
                columns: new[] { "ClientId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_BillingItems_DueDate",
                table: "BillingItems",
                column: "DueDate");
