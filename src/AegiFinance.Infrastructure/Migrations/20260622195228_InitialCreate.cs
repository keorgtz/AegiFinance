    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientPinCredentials", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateToMXN = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    RateFromMXN = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPinCredentials_UserId",
                table: "ClientPinCredentials",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CurrencyConfigs_Code",
