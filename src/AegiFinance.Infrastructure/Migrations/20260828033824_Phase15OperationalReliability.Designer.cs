...
namespace AegiFinance.Infrastructure.Migrations
{
    ...
    [Migration("20260828033824_Phase15OperationalReliability")]
    partial class Phase15OperationalReliability
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.AccountStatementInquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("StatementVerificationCode")
                        .HasMaxLength(32)
                    ...
                    b.HasIndex("ClientId", "Status", "RequestedAt");

                    b.ToTable("AccountStatementInquiries");
                });
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.AccountingPeriod", b =>
                {
                    ...
                    b.Property<string>("CloseChecklistJson")
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CloseVerificationCode")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.Property<int>("GovernanceVersion")
                        .IsConcurrencyToken()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.AccountingPeriodReopenRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AccountingPeriodReopenRequests");
                });
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.BillingItem", b =>
                {
                    ...
                    b.Property<int>("PaymentAllocationVersion")
                        .IsConcurrencyToken()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Status", "AvailableAt", "LockedUntil");

                    b.ToTable("OutboxMessages");
                });

            modelBuilder.Entity("AegiFinance.Domain.Entities.PaymentApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ReappliesPaymentApplicationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReappliesPaymentApplicationId");

                    b.HasIndex("ClientId", "AppliedAt");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.PaymentApplicationPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("UnappliedAfter")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("PaymentApplicationId", "LedgerEntryId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("PaymentApplicationPayments");
                });

            modelBuilder.Entity("AegiFinance.Domain.Entities.PaymentApplicationSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PaymentApplicationSettings");
                });
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.ReportRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.ReportSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.SubscriptionAllocation", b =>
                {
                    ...
                    b.HasIndex("PaymentApplicationId", "IsReversed");
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.AccountingPeriodReopenRequest", b =>
                {
                    ...
                    b.HasOne("AegiFinance.Domain.Entities.Organization", "Organization")
                        .WithMany("AccountingPeriodReopenRequests")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.PaymentApplication", b =>
                {
                    ...
                    b.HasOne("AegiFinance.Domain.Entities.Service", "PreferredService")
                        .WithMany()
                        .HasForeignKey("PreferredServiceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AegiFinance.Domain.Entities.PaymentApplication", "ReappliesPaymentApplication")
                        .WithMany()
                        .HasForeignKey("ReappliesPaymentApplicationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("ReappliesPaymentApplication");
                });
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.PaymentApplicationPayment", b =>
                {
                    ...
                    b.HasOne("AegiFinance.Domain.Entities.PaymentApplication", "PaymentApplication")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.ReportRun", b =>
                {
                    ...
                    b.HasOne("AegiFinance.Domain.Entities.ReportSchedule", "ReportSchedule")
                        .WithMany("Runs")
            ...
            modelBuilder.Entity("AegiFinance.Domain.Entities.Organization", b =>
                {
                    b.Navigation("AccountingPeriodReopenRequests");
