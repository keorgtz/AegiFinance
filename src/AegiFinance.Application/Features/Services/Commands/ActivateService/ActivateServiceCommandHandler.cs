...
public class ActivateServiceCommandHandler : IRequestHandler<ActivateServiceCommand>
{
    ...
    public ActivateServiceCommandHandler(IApplicationDbContext context, ICurrentUserService currentUserService)
    {
        _context = context;
    ...
    public async Task Handle(ActivateServiceCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new UnauthorizedAccessException("No tiene permiso para activar servicios.");
        }
