...
public static class SeedData
{
    ...
    {
        var action = Regex.Match(code, "^(View|Create|Update|Delete|Manage|Generate|Cancel|Close|Reconcile|Reprocess|Allocate|Unallocate|Sync|Apply|Reverse|Reapply|Export|Download|Resolve|Request|Approve)").Value;
